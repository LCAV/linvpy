...
setup(
    ...
    url='https://github.com/LCAV/linvpy.git',
    ...
    keywords='linear inverse M-estimator Tau-estimator regression',
    ...
    packages=find_packages(exclude=['contrib', 'docs', 'tests', 'regularizedtau']),
