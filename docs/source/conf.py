...
MOCK_MODULES = ['numpy', 'scipy', 'matplotlib', 'matplotlib.pyplot', 'scipy.interpolate', 'scipy.special', 'math', '__future__', 'toolboxutilities', 'linvpy_toolbox']
...
latex_documents = [
    (master_doc, 'linpy.tex', u'linpy Documentation',
...
man_pages = [
    (master_doc, 'linpy', u'linpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'linpy', u'linpy Documentation',
     author, 'linpy', 'One line description of project.',
     'Miscellaneous'),
]
