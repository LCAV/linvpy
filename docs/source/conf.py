...
MOCK_MODULES = ['numpy', 'scipy', 'matplotlib', 'matplotlib.pyplot', 'scipy.interpolate', 'scipy.special', 'math', '__future__', 'toolboxutilities']
...
latex_documents = [
    (master_doc, 'linvpy.tex', u'linvpy Documentation',
     u'Guillaume Beaud, Marta Martinez-Camara', 'manual'),
]
